...
const NavBar = ({ isFocusMode, onFocusToggle }: NavBarProps) => {
    ...
    const handleLogout = async () => {
        // Revoke the session server-side (blacklists the token by jti) and
        // clear ALL session data locally. The token / refresh_token were the
        // critical items missing before - leaving them meant the session was
        // never actually invalidated on logout.
        await logoutUser();

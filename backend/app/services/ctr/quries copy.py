def get_entity_deposit_query(trxn_date):

    # ------------------------------------------- CASH DEPOSIT (CREDIT) ENTITY TRANSACTIONS QUERY -------------------------------------------
    ...
    query = f"""
		...
		WHERE 1=1
		--AND FCT.TSACTN_ID IN ('6577154049')
	...
	, DIRECTORS AS (
		...
		SELECT * FROM (
			...
			case when d.PERM_ADDR is not null and d.PERM_ADDR <> '' then 'PAPVT' 
						when d.PERM_ADDR is null then 'PAOFF' end 
	   ...
	   TRIM(OREPLACE(OREPLACE( 
		...
		, MAX(
			...
			WHEN DD.D_RN IS NULL AND M.M_RN IS NULL   THEN D.FTHR_NAME
			END
		) AS DIR1_FATHER_NAME
		...
		, MAX(
		    ...
		    WHEN DD.D_RN IS NULL AND M.M_RN = 9 THEN M.M_DT_OF_BIRTH
			WHEN DD.D_RN IS NULL AND M.M_RN IS NULL   THEN CAST(NULL AS VARCHAR(50))
			END
		...
		, MAX(
		    ...
		    WHEN DD.D_RN IS NULL AND M.M_RN = 10 THEN M.M_DT_OF_BIRTH
			WHEN DD.D_RN IS NULL AND M.M_RN IS NULL   THEN CAST(NULL AS VARCHAR(50))
			END
		...
		, MAX(
			...
			WHEN M.M_RN IS NULL AND DD.D_RN IS NULL   THEN D.FTHR_NAME
			END
		...
		WHERE 1=1 
		GROUP BY 
		CATEGORY_TYPE_DESC,transactionnumber,transaction_location,transaction_description,date_transaction,teller,authorized,transmode_code,amount_local,TFMC_from_funds_code,TFMC_Gender,
		...
		CAST(DIR1_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR1_DATE_OF_BIRTH,
		...
		CAST(DIR2_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR2_DATE_OF_BIRTH,
		...
		CAST(DIR3_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR3_DATE_OF_BIRTH,
		...
		CAST(DIR4_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR4_DATE_OF_BIRTH,
		...
		CAST(DIR5_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR5_DATE_OF_BIRTH,
		...
		CAST(DIR6_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR6_DATE_OF_BIRTH,
		...
		CAST(DIR7_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR7_DATE_OF_BIRTH,
		...
		CAST(DIR8_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR8_DATE_OF_BIRTH,
		...
		CAST(DIR9_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR9_DATE_OF_BIRTH,
		...
		CAST(DIR10_DATE_OF_BIRTH AS VARCHAR(20)) AS DIR10_DATE_OF_BIRTH,
		...
		CAST(SIGNATORY1_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY1_DATE_OF_BIRTH,
		...
		CAST(SIGNATORY2_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY2_DATE_OF_BIRTH,
		...
		CAST(SIGNATORY3_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY3_DATE_OF_BIRTH,
		...
		CAST(SIGNATORY4_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY4_DATE_OF_BIRTH,
		...
		CAST(SIGNATORY5_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY5_DATE_OF_BIRTH,
		...
		CAST(SIGNATORY6_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY6_DATE_OF_BIRTH,
		...
		CAST(SIGNATORY7_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY7_DATE_OF_BIRTH,
		...
		CAST(SIGNATORY8_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY8_DATE_OF_BIRTH,
...
def get_entity_withdrawal_query(trxn_date):
# ------------------------------------------- CASH WITHDRAWAL (DEBIT) ENTITY TRANSACTIONS QUERY -------------------------------------------
    ...
    query = f"""
		...
		ON FCT.CURY_EDW_ID = EXC.CURY_EDW_ID
		WHERE 1=1
		-- AND FCT.TSACTN_ID IN ('6390660859')
		AND FCT.TSACTN_TYPE_EDW_ID IN ('0001','0201','0006')
		AND FCT.TSACTN_DT BETWEEN '{trxn_date}' AND '{trxn_date}'
		AND CASE WHEN EXC.CURY_EDW_ID IS NOT NULL THEN FCT.TSACTN_AMT * CCY_RATE ELSE FCT.TSACTN_AMT END >= '2000000'
		AND 
	...
	, DIRECTORS AS (
	   ...
	   TRIM(OREPLACE(OREPLACE( 
		...
		WHERE 1=1 
		GROUP BY 
		CATEGORY_TYPE_DESC,transactionnumber,transaction_location,transaction_description,date_transaction,teller,authorized,transmode_code,amount_local,
		...
		CAST(SIGNATORY3_FATHER_NAME AS VARCHAR(99)) AS SIGNATORY3_FATHER_NAME,
		CAST(SIGNATORY3_SSN_TYPE AS VARCHAR(10)) AS SIGNATORY3_SSN_TYPE,
		CAST(CASE WHEN SIGNATORY3_SSN_TYPE IN ('NIC', 'PPT', 'POC') THEN SIGNATORY3_SSN ELSE CAST(NULL AS VARCHAR(10)) END AS VARCHAR(30)) AS SIGNATORY3_SSN,	
		CAST(SIGNATORY3_TPH_NUMBER AS VARCHAR(50)) AS SIGNATORY3_TPH_NUMBER,
		CAST(SIGNATORY3_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY3_DATE_OF_BIRTH,
		CAST(SIGNATORY3_ADDRESS AS VARCHAR(99)) AS SIGNATORY3_ADDRESS,
		CAST(SIGNATORY3_OCCUPATION AS VARCHAR(99)) AS SIGNATORY3_OCCUPATION,
		...
		CAST(SIGNATORY4_FATHER_NAME AS VARCHAR(99)) AS SIGNATORY4_FATHER_NAME,
		CAST(SIGNATORY4_SSN_TYPE AS VARCHAR(10)) AS SIGNATORY4_SSN_TYPE,
		CAST(CASE WHEN SIGNATORY4_SSN_TYPE IN ('NIC', 'PPT', 'POC') THEN SIGNATORY4_SSN ELSE CAST(NULL AS VARCHAR(10)) END AS VARCHAR(40)) AS SIGNATORY4_SSN,	
		CAST(SIGNATORY4_TPH_NUMBER AS VARCHAR(50)) AS SIGNATORY4_TPH_NUMBER,
		CAST(SIGNATORY4_DATE_OF_BIRTH AS VARCHAR(20)) AS SIGNATORY4_DATE_OF_BIRTH,
		CAST(SIGNATORY4_ADDRESS AS VARCHAR(99)) AS SIGNATORY4_ADDRESS,
		CAST(SIGNATORY4_OCCUPATION AS VARCHAR(99)) AS SIGNATORY4_OCCUPATION,
		...
		CAST(TTMC_Birth_Date AS VARCHAR(20)) AS TTMC_Birth_Date,
...
def get_individual_deposit_query(trxn_date):
   #  ------------------------------------------- CASH DEPOSIT (CREDIT) INDIVIDUAL TRANSACTIONS QUERY -------------------------------------------
    ...
    query = f"""
	    ...
	    AND 
		( 
		ACCT.CUST_TYPE_EDW_ID NOT IN ( '63','51','36','31','61','34','53','37','35','65','33','32','55','62','64','54','52')  AND ACCT.SYSTEM_CODE = 'CBS'
		AND (
		NOT EXISTS(
		SELECT 1 FROM DP_SDMVW_DFDN.DIM_CTR_Keywords_VW t 
		WHERE t.flag = 'NO' AND ACCT.ACCT_TITL LIKE '%' || t.keyword || '%'
...
def get_individual_withdrawal_query(trxn_date):
#        ----------------------------------------------------  CASH WITHDRAWAL (DEBIT) INDIVIDUAL TRANSACTIONS QUERY ------------------------------------------------------
    ...
    query = f"""
		...
		ON FCT.CURY_EDW_ID = EXC.CURY_EDW_ID
		WHERE 1=1
		--AND FCT.TSACTN_ID IN ('6577040942', '6577371871', '6575003750')
		AND FCT.TSACTN_TYPE_EDW_ID IN ('0001','0201','0006')
		AND FCT.TSACTN_DT BETWEEN '{trxn_date}' AND '{trxn_date}'
		AND CASE WHEN EXC.CURY_EDW_ID IS NOT NULL THEN FCT.TSACTN_AMT * CCY_RATE ELSE FCT.TSACTN_AMT END >= '2000000'
		AND 
